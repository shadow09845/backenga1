          ...
          <div className="account-wrapper" style={{ position: 'relative' }}>
            ...
            {accountOpen && (
              <div className="account-modal" style={{
                ...
                <Link to="/" style={{ textDecoration: 'none', color: '#333' }}>{t('logout')}</Link>
                <Link to="/about" style={{ textDecoration: 'none', color: '#333' }}>{t('about')}</Link>
                <Link to="/contact" style={{ textDecoration: 'none', color: '#333' }}>{t('contact')}</Link>
              </div>
            )}
          </div>
